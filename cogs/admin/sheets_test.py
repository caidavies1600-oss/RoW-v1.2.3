...
class SheetsTest(commands.Cog):
    ...
    async def sheets_diagnostics(self, ctx):
        ...
        try:
            ...
            env_status = "✅ Complete" if (creds_exists and sheets_id_exists) else "❌ Incomplete"
            embed.add_field(
            ...
            bot_sheets_status = "✅ Available" if hasattr(self.bot, 'sheets') and self.bot.sheets else "❌ Not Available"
            embed.add_field(
