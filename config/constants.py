...
ROW_NOTIFICATION_ROLE_ID = 1235729244605120572  # Filter members by this role to reduce API calls

# === Channel Config ===
ALERT_CHANNEL_ID = 1311377465087885314
...
FILES = {
    ...
    "ABSENT": ABSENT_FILE,
    "SIGNUP_LOCK": os.path.join(DATA_DIR, "signup_lock.json"),  # NEW: Track signup lock state
